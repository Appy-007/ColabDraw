    ...
    <div className="flex items-center justify-between">
        <div className="flex gap-2 items-center justify-start">
          <div>
            ...
            <input type="radio" checked={tool===ToolType.PENCIL} value={ToolType.PENCIL} name="tool" onChange={(e)=>setTool(e.target.value)}/>
          </div>
          <div>
            <label htmlFor="line" className="pr-1">Line</label>
            <input type="radio"  checked={tool===ToolType.LINE} value={ToolType.LINE} name="tool" onChange={(e)=>setTool(e.target.value)}/>
          </div>
          <div>
            <label htmlFor="rectangle"  className="pr-1">Rectangle</label>
            <input type="radio" checked={tool===ToolType.RECTANGLE} value={ToolType.RECTANGLE} name="tool" onChange={(e)=>setTool(e.target.value)}/>
          </div>
        </div>
