...
export default function Scoreboard(params:ScoreboardProps) {
  ...
  return (
    <>
      <div className="bg-white p-2 sm:p-4 rounded-xl shadow-lg border border-gray-200">
        <h3 className="text-md sm:text-lg font-bold mb-3 text-gray-700">Scoreboard</h3>
        <div className="space-y-2">
          {scoreBoard
            ...
            .map((member) => (
              <div
                key={member.userId}
                className={`flex justify-between items-center p-2 rounded-lg max-sm:text-xs ${
